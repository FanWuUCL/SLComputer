...
//                }
    ...
    public static byte[] communicate(BufferedOutputStream os, BufferedInputStream is, int command, int[] expectCommands, byte[] extra){
        ...
        byte[] data=transform(length, 2000000+((int)(arguments[arguments.length-1])==0?1008000:((arguments[arguments.length-1])==4?1008000:1008000)), globalCer, command, extralength, extra);
