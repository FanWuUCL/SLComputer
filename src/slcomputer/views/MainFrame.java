...
import slcomputer.views.JDialogHeroChooser;
import slcomputer.heros.Hero;
import slcomputer.utils.Animator;
import slcomputer.computer.Team;
import slcomputer.computer.SLData;
import slcomputer.computer.BattleField;
import slcomputer.views.dialogs.JDialogLogin;
...
import slcomputer.views.dialogs.JDialogAutoBB;
...
public class MainFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItemChest = new javax.swing.JMenuItem();
        ...
        jMenuItemStartBB.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemStartBBActionPerformed(evt);
            }
        });
        ...
        jMenuItemChest.setText("开宝箱");
        jMenuItemChest.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItemChestActionPerformed(evt);
            }
        });
        jMenuAccount.add(jMenuItemChest);
        jMenuAccount.add(jSeparator5);
...
/*        if(rateHard>80){
    ...
    private void jMenuItemStartBBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemStartBBActionPerformed
        if(!SocketMaster.globalReady){
            return;
        }
    ...
    private void jMenuItemChestActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItemChestActionPerformed
        SLComputer.cleanBB(true);
        if(SocketMaster.character==null){
            JOptionPane.showMessageDialog(SLComputer.mf, "该功能暂不可用。",
                        "版本问题", JOptionPane.INFORMATION_MESSAGE);
            return;
        }
        JDialogChest diag=new JDialogChest(this, true, SocketMaster.character.numGoldenKey,
